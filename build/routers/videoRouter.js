...
videoRouter.route("/upload").get(_videoController.getUpload).all(_middlewares.protectorMiddleware).post(_middlewares.videoUpload.single("video"), _videoController.postUpload);
