...
exports.startGithubLogin = exports.profile = exports.postLogin = exports.postJoin = exports.postEdit = exports.postChangePassword = exports.logout = exports.getLogin = exports.getJoin = exports.getEdit = exports.getChangePassword = exports.finishGithubLogin = void 0;
...
var postJoin = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, email, name, username, password, password2, location, userExists;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _req$body = req.body, email = _req$body.email, name = _req$body.name, username = _req$body.username, password = _req$body.password, password2 = _req$body.password2, location = _req$body.location;
          if (!(password !== password2)) {
            _context.next = 3;
            break;
          }
          return _context.abrupt("return", res.status(400).render("user/createAccount", {
            pageTitle: "Create Account",
        ...
        case 14:
          ...
          return _context.abrupt("return", res.status(404).render("user/createAccount", {
            pageTitle: "Create Acoount",
            error: _context.t0._message
          }));
        case 17:
        case "end":
...
var finishGithubLogin = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var config, params, url, tokenRequest, access_token, apiurl, userData, emailData, emailObj, user;
  ...
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _req$session$user = req.session.user, _id = _req$session$user._id, avatarUrl = _req$session$user.avatarUrl, _req$body3 = req.body, name = _req$body3.name, email = _req$body3.email, username = _req$body3.username, location = _req$body3.location, file = req.file; //이미 있는 유저네임이나 이메일 사용시 불가능 하게 만드는 코드!!!
          _context4.next = 3;
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 6:
          ...
          return _context5.abrupt("return", res.status(400).render("user/changePassword", {
            pageTitle: "Change Pasword",
...
var profile = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 8:
          ...
          return _context6.abrupt("return", res.render("user/profile.pug", {
  ...
  return function profile(_x11, _x12) {
